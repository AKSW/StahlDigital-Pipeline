...
process generateSites {
    container params.ciJodImage ?: 'git.infai.org:4567/materialdigital/stahldigital/jod-for-stahl:main'
    debug params.debug
    ...
    # workaround on html output for hrefs with additional "/ProcessOntology/" prefix 
    sed -i 's|href=".//ProcessOntology/|href="./|' \$HTMLS_DIR/*.html
    # workaround on html output for href with "href=".//rdfsites/http/" prefix
    sed -i 's|href=".//rdfsites/http/|href="http://|' \$HTMLS_DIR/*.html
    '''
}
